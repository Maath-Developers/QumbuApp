        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Purpose1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Purpose2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Purpose3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Purpose4 = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Profiling_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Profiling_AspNetUsers_PatientID",
                        column: x => x.PatientID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Queue", x => x.QueID);
                    table.ForeignKey(
                        name: "FK_Queue_AspNetUsers_MainUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_vaccinerecord_AspNetUsers_NurseID",
                        column: x => x.NurseID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Profiling_Id",
                table: "Profiling",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IX_Profiling_PatientID",
                table: "Profiling",
                column: "PatientID");

            migrationBuilder.CreateIndex(
                name: "IX_Queue_MainUserId",
                table: "Queue",
                column: "MainUserId");
