...
{
<<<<<<<< HEAD:Qumbu_Community_Health_Care_Center/Migrations/20231017163434_file.cs
    public partial class file : Migration
========
    public partial class Init : Migration
>>>>>>>> d685c65fd1f53a01195fd8c7f21a8d6d5e3d84c2:Qumbu_Community_Health_Care_Center/Migrations/20231016151638_Init.cs
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PrenatalEducationID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_prenatalEducation", x => x.PrenatalEducationID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GestationalAgeWeeks = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FetalHeartRate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Observations = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GenderDetermined = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Comments = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UltrasoundImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    rating2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    rating3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    rating4 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    rating5 = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrenatalGallery", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrenatalGallery_prenatalEducation_PrenatalEducationID",
                        column: x => x.PrenatalEducationID,
                        principalTable: "prenatalEducation",
                        principalColumn: "PrenatalEducationID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrenatalGallery_PrenatalEducationID",
                table: "PrenatalGallery",
                column: "PrenatalEducationID");
        }
